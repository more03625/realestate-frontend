...
const Content = () =>  {
    ...
    const isValid = () => {
        ...
        }else if(emailOTP.length < 6 || emailOTP === ""){
            setEmailOTPError("Please enter valid email OTP of 6 digit.");
        }else if(phoneOTP.length < 6 || phoneOTP === ""){
            setPhoneOTPError("Please enter valid phone OTP of 6 digit.");
        }else{
            return true;
        }
    }
